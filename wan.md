...
#### Часть 3
Шаг 1: Настройте OSPFv2 на маршрутизаторах R1, R2 и R3
...
Шаг 4: Используйте ID процесса 100 для OSPF на всех маршрутизаторах (R1, R2 и R3).

Шаг 5: Настройте интерфейс f0/0 маршрутизатора R1 так, чтобы он принадлежал зоне
1

Шаг 6: Настройте интерфейс f0/1 маршрутизатора R1 так, чтобы он принадлежал зоне
0
...
В R3 будет команда default-information originate
